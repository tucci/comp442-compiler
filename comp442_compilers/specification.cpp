...
specification::specification() {
	...
	state* dot_state = spec.create_state(true, false, token_type::dot);
	...
	state* comma_state = spec.create_state(true, false, token_type::comma);
	...
	// < less than token
	state* lt_state = spec.create_state(true, false, token_type::lt);
	...
	// > greater than token
	state* gt_state = spec.create_state(true, false, token_type::gt);
	...
	// = assignment token
	state* assgn_state = spec.create_state(true, false, token_type::assgn);
	...
	state* add_state = spec.create_state(true, false, token_type::adddop);
	...
	state* subtract_state = spec.create_state(true, false, token_type::subtractop);
	...
	state* mult_state = spec.create_state(true, false, token_type::multop);
	...
	state* div_state = spec.create_state(true, false, token_type::divop);
	...
	state* openpar_state = spec.create_state(true, false, token_type::openpar);
	...
	state* closepar_state = spec.create_state(true, false, token_type::closepar);
	...
	state* openbrace_state = spec.create_state(true, false, token_type::openbrace);
	...
	state* closebrace_state = spec.create_state(true, false, token_type::closebrace);
	...
	state* opensquare_state = spec.create_state(true, false, token_type::opensquare);
	...
	state* closesquare_state = spec.create_state(true, false, token_type::closesquare);
	...
	state* semicolon_state = spec.create_state(true, false, token_type::semicolon);
